...
<?php } ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Kelola SPDP</li>
          </ol>
        </section>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Data SPDP</h3>
    ...
    <tbody>
                ...
                <div class="box-footer clearfix no-border">
                  <a href="input-member.php" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Tambah SPDP</a>
                  </div>
              </div><!-- /.box -->
