        ...
        <section class="content">
          ...
          <div class="row">
			...
			/** if(isset($_POST['update'])){
				...
				$update = mysqli_query($koneksi, "UPDATE karyawan SET nama='$nama', bagian='$bagian', k1_join='$k1_join', k1_finish='$k1_finish', k2_join='$k2_join', k2_finish='$k2_finish', status='$status', jpu='$jpu', jpuu='$jpuu' WHERE nik='$kd'") or die(mysqli_error());
				if($update){
...
//{
	...
	//{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="UPDATE karyawan SET nama='$nama', bagian='$bagian', k1_join='$k1_join', k1_finish='$k1_finish', k2_join='$k2_join', k2_finish='$k2_finish', status='$status', jpu='$jpu', jpuu='$jpuu', gambar='$gambar' WHERE nik='$kd'";
			...
			?>
                ...
                <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                         <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="nik" type="text" id="nik" class="form-control" value="<?php echo $row['nik']; ?>" placeholder="Asal SPDP" autocomplete="off" autofocus="on" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-4">
                            <input name="nama" type="text" id="nama" class="form-control" value="<?php echo $row['nama']; ?>" placeholder="Nama Tersangka" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="bagian" type="text" id="bagian" class="form-control" value="<?php echo $row['bagian']; ?>" placeholder="No SPDP" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k1_join' value="<?php echo $row['k1_join']; ?>" id="tanggal_beli" placeholder='Tanggal SPDP' required />
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input name="k1_finish" type="text" id="k1_finish" class="form-control" value="<?php echo $row['k1_finish']; ?>" placeholder="Pasal SPDP" autocomplete="off" required />
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k2_join' value="<?php echo $row['k2_join']; ?>" id="tanggal_beli" placeholder='Tanggal Terima SPDP' required />
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                            <input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='k2_finish' value="<?php echo $row['k2_finish']; ?>" id="tanggal_beli" placeholder='Batas Waktu' required />
						  ...
						  <div class="form-group">
							...
							<label class="col-sm-3 col-sm-3 control-label">JPU I Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary"><?php echo $row['jpu']; ?></span>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">JPU</label>
							...
							<label class="col-sm-3 col-sm-3 control-label">JPU II Sebelumnya : </label>
                              <div class="col-sm-3">
                              <span class="label label-primary"><?php echo $row['jpuu']; ?></span>
                              </div>
                          </div>						  
                          <div class="form-group">
